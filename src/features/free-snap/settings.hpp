...
namespace Settings::FreeSnap {
    ...
    inline SillySetting<float> gridSize{"Grid Size", "Free Snap", 15.0f, {1.0f, std::nullopt}};
    ...
    inline SillySetting<float> snapIndicatorFill{"Snap Indicator Fill", "Free Snap", 0.25f, {0.0f, 1.0f}, "opacity of snap indicator fill"};
    inline SillySetting<float> snapIndicatorThickness{"Snap Indicator Thickness", "Free Snap", 1.0f, {0.0f, std::nullopt}};
