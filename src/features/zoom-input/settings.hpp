...
namespace Settings::ZoomInput {
    ...
    inline SillySetting<float> zoomInputScale{"Zoom Input Scale", "Zoom Input", 1.0f, {0.0f, std::nullopt}, SettingReload::Editor};
    ...
    inline SillySetting<bool> noConstrainPosition{"No Constrain Position", "Zoom Input", false, "use at ur own risk idk if this is a good hacky workaround uwu, works regardless of zook input being enabled"};
}