...
namespace Settings::DefaultObjectOptions {
    ...
    inline SillySetting<bool> dontEnter{"Dont Enter", "Default Object Options", false, "dont recommend turning this one on - dont fade is prolly wat u want but u do u"};
    inline SillySetting<bool> noGlow{"No Glow", "Default Object Options", false};
    inline SillySetting<bool> useJSON{"Use JSON", "Default Object Options", false, "most ppl will prolly find this useful enough for auto enabling noglow/dontfade but if you want more advanced settings like obj str f***ery u can use json :333"};
